...
if ($_POST){ 
    ...
    @$razo=$_POST['razon'];
    @$tfech=$_POST['fechev'];
    @$tiporeu=$_POST['tiporeu'];
    @$minudc=$_POST['minutadoc']; 
    @$arch=$_POST['myfile'];  
    @$curs=$_POST['cursos']; 
    

    $CREAR = "INSERT INTO `bdflorencia`.`reunion` (`idReunion`, `tituloReunion`, `razonReunion`, `fechaReunion`, `minuta`, `tipo`, `Archivo`, `Curso_idCurso`) 
    VALUES (NULL, '$titu', '$razo', '$tfech', '$minudc', '$tiporeu', '$arch','$curs');";
       
       //INSERT INTO `bdflorencia`.`reunion` (`idReunion`, `tituloReunion`, `razonReunion`, `fechaReunion`, `minuta`, `tipo`, `Archivo`, `Curso_idCurso`) VALUES (NULL, 'Prueba', 'Prueba1', '2020-05-30', 'gdfsgdfsgfdsgfd', 'Otro', '', '3');
              ...
              <div class="container">
                  ...
                  <div    id="navbar" class="navbar-collapse collapse">
                      <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                          ...
                          <li><a href="#">Minutas de Reunión</a></li>
                                          ...
                                          <div class="col-md-12">
                                              <div class="mu-latest-course-single">
                                                  ...
                                                  <div class="mu-latest-course-single-content">
                                                      ...
                                                      <img />
                                                      &nbsp;&nbsp;&nbsp;
                                                      <h2><a href="#" style=" float: right;"> Modulo de Minutas de Reunión</a></h2>
                                                    ...
                                                    <!-- Metodo que llama el nombre y ramo impartido del profesor de la sesión actual --> 
                                                      ...
                                                      <form  action="P-Minutas.php" method="post" class="contact100-form validate-form">
                                                     ...
                                                     <!-- Metodo que llama a los cursos del profesor asignado -->
                                                      ...
                                                      <div class="container-contact100">
                                                          <div class="wrap-contact100">
                                                                  ...
                                                                  <div class="wrap-input100 input100-select bg1">
                                                                      <span class="label-input100">Tipo de Reunión *</span>
                                                                      <div>
                                                                          <select style="width:300px;" class="js-select2" name="tiporeu">
                                                                  ...
                                                                  <div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate="Please Type Your Message">
                                                                      <span class="label-input100">Minuta</span>
                                                                      <textarea class="input100" name="minutadoc" placeholder="Redacte la Minuta Aquí..."></textarea>
                                                                  </div>
                                                      ...
                                                      <br />
                                                      <br />
                                                      <h4>Historial de Minutas Enviadas</h4>
