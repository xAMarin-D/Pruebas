...
if ($_POST){ 
    ...
    @$tituev=$_POST['tituloev'];
    @$feche=$_POST['fechev'];
    @$tipoev=$_POST['tipoev'];
    @$contev=$_POST['contenido'];
    @$objev=$_POST['objetivos'];    
    @$archev=$_POST['myfile'];
    @$cur=$_POST['cursos'];

    //INSERT INTO `bdflorencia`.`evaluacion` (`idEvaluacion`, `tituloEvaluacion`, `fechaEvaluacion`, `tipoEvaluacion`, `contenidoEvaluacion`, `objetivosEvaluacion`, `archivoEvaluacion`, `Curso_idCurso`) 
    //VALUES (NULL, 'Geoquimica Aplicada', '2020-12-16', 'Brigidaaaaaaaaa', 'KKCK', 'no sacarse un rojo', '', '1');

    $CREAR = "INSERT INTO `bdflorencia`.`evaluacion` (`idEvaluacion`, `tituloEvaluacion`, `fechaEvaluacion`, `tipoEvaluacion`, `contenidoEvaluacion`, `objetivosEvaluacion`, `archivoEvaluacion`, `Curso_idCurso`) 
    VALUES (NULL, '$tituev', '$feche', '$tipoev', '$contev', '$objev', '$archev','$cur');";
...
<head>
    ...
    <!-- Hoja de estilos Main -->
    <link href="assets/css/style.css" rel="stylesheet">

    <!--===============================================================================================-->
    <!--================================Animaciones y extras en CSS ===================================-->
    <!--===============================================================================================-->
              ...
              <div class="container">
                  ...
                  <div    id="navbar" class="navbar-collapse collapse">
                      <ul id="top-menu" class="nav navbar-nav navbar-right main-nav">
                          ...
                          <li><a href="#">Planificador de Evaluaciónes</a></li>
                                          ...
                                          <div class="col-md-12">
                                              <div class="mu-latest-course-single">
                                                  ...
                                                  <div class="mu-latest-course-single-content">
                                                      ...
                                                      <img />
                                                      &nbsp;&nbsp;&nbsp;
                                                      <h2><a href="#" style=" float: right;"> Modulo de Planificación de Evaluaciones</a></h2>
                                                    ...
                                                    <!-- Metodo que llama el nombre y ramo impartido del profesor de la sesión actual --> 
                                                      ...
                                                      <label for="cursos">Cursos a Cargo: </label>
                                                        <form action="P-Planificador.php" method="post"   class="contact100-form validate-form">
                                                      ...
                                                      <div class="container-contact100">
                                                          <div class="wrap-contact100">
                                                                  ...
                                                                  <span style=" font-family:Calibri" class="contact100-form-title">
                                                                      <strong>Planificador de Evaluaciones</strong>
                                                                  </span>

                                                                  <div class="wrap-input100 validate-input bg1" data-validate="Porfavor Escriba un Titulo">
                                                                      <span class="label-input100">TITULO *</span>
                                                                      <input class="input100" type="text" name="tituloev" placeholder="Ingrese el titulo de la Evaluación">
                                                                  </div>

                                                                  <div class="wrap-input100 validate-input bg1" data-validate="Porfavor Ingrese una Fecha Valida">
                                                                     
                                                                      <span class="label-input100">FECHA DE LA EVALUACIÓN *</span>
                                                                      <br />

                                                                    <input type="date" name="fechev" step="1" min="2020-05-01" max="2050-12-31" >
                                                                  ...
                                                                  <div class="wrap-input100 input100-select bg1">
                                                                      <span class="label-input100">Tipo de Evaluación *</span>
                                                                      <div>
                                                                          <select style="width:300px;" class="js-select2" name="tipoev">
                                                                  ...
                                                                  <div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate="Porfavor Escriba un Contenido">
                                                                      <span class="label-input100">Contenido</span>
                                                                      <textarea class="input100" name="contenido" placeholder="Ingrese el Contenido a Ver..."></textarea>
                                                                  </div>

                                                                  
                                                                  <div class="wrap-input100 validate-input bg0 rs1-alert-validate" data-validate="Porfavor Escrba los de la Evaluación">
                                                                      <span class="label-input100">Objetivos</span>
                                                                      <textarea class="input100" name="objetivos" placeholder="Ingrese los Objetivos a Lograr..."></textarea>
                                                                  </div>
                                                                  ...
                                                                  <div>
                                                                      ...
                                                                      <form action="/action_page.php">
                                                                          <label for="myfile">O Seleccione un Archivo:</label>
